...
public class YAMP extends JFrame implements ActionListener {
    ...
    public YAMP() {
        setTitle("YAMP - Yet Another Media Player");
        setSize(530, 300);
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        setLayout(new BorderLayout());

        // Set custom icon
        ImageIcon icon = new ImageIcon("music-player.png");  // Replace with the path to your icon image
        ...
        chooseFolderButton = new JButton("Playlist");
        ...
        chooseFolderButton.addActionListener(e -> {
            ...
            int result = folderChooser.showOpenDialog(YAMP.this);
